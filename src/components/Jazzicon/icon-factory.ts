import { isValidHexAddress, toChecksumHexAddress } from "./hexstring-utils"
...
function iconExistsFor(address, tokenList) {
  return tokenList[address] && isValidHexAddress(address, { allowNonPrefixed: false }) && tokenList[address].iconUrl
}
